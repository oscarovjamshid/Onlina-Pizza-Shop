...
// if update_product button is clicked, then go to DB to do....(update creds)
if(isset($_POST['update_product'])){

   // sends credentials to database phpadmin to update
   $pid = $_POST['pid'];
   $name = $_POST['name'];
...
<section class="update-product">
   ...
   <!-- connects to db to get product credentials within rows in db -->
   <?php
   ...
   <!-- form to gather all inputs to be updated and fetched -->
